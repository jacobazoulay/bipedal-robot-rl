...
def normalize(observation):
    observation = torch.multiply(observation, 0.5)
    observation = torch.add(observation, 0.5)
    return observation
...
k_1 = 1000    # iterations of Q_ update
...
torch.save(Q, "Q_Lunar.pt")
np.savetxt("Rewards_Lundar.csv", reward_sums, delimiter=", ", fmt='% s')
